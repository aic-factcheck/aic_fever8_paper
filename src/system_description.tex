...
\label{sec:system}
Our system is designed to be simple and its core could be described as simply a RAG pipeline with customized retriever and LLM prompting (Listing~\ref{lst:llm_system_prompt} \review{in Appendix~\ref{appendix_sec:system_prompt}}).
