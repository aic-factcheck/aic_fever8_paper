...
\begin{enumerate}
    ...
    The provided \textbf{baseline} is a pipeline of question generation, sentence retrieval, another question generation, pre-classification, rerankning, post-classification and label aggregation, achieving an overall \averitec{} score 0.11.  
